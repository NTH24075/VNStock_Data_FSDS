"""Silver transformations — Bronze Delta → Silver Delta (PySpark).

Dedup by business key, schema harmonization across v1/v2 boundary, domain checks.

Usage:
    python jobs/silver_transform.py --bronze-dir data/bronze --silver-dir data/silver
"""
...
def read_bronze_ohlcv(spark: SparkSession, bronze_dir: str) -> DataFrame:
    ...
    # Schema harmonization: ensure value and foreign_room exist
